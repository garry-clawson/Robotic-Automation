...
This ReadMe is an overview of work I completed that took place over a 3 month period in mid 2017 to specify, design, build and programmed to eliminate a productivity constraint. 8 x robotic automation machines to automate a highly skilled task (Gas regulator hose and brass insert assembly) were required improve a process that was a high cost, labour intensive, difficult to manage and ensure constant quality. 
